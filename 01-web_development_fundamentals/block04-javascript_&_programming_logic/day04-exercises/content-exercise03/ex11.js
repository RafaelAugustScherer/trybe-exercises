...
IR = calculateIR(salary - INSS)
FinalSalary = salary - INSS - IR

console.log(`Salário Bruto: ${salary}`)
console.log(`Salário Base: ${salary - INSS}`)
console.log(`Salário Líquido: ${FinalSalary}`)