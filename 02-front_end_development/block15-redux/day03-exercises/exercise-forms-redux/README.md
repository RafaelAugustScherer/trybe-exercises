...
**Atenção**! A branch `exercise-react-redux` não possui a estrutura do formulário pronta, sendo necessária sua implementação. Caso prefira implementar somente o Redux, basta acessar a branch `master` e seguir as instruções descritas no README.
